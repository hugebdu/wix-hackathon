var Wix = (function () {
    var _w = {
        ...
        addPostMessageCallback: function ( callback ) {
            ...
            window[func](event, callback, false);
        },

        _removePostMessageCallback: function (callback) {
           var func = "removeEventListener";
           var event = "message";
           if (window.attachEvent) {
               func = "detachEvent";
               event = "onmessage";
    ...
    return {
        ...
        openPopup: function(url, size, minSize){
            var args = {
                url    : url,
                size   : size,
                minSize: minSize
        ...
        changeAppSize:function (width, height) {
            _w.sendMessageInternal(_w.MessageTypes.CHANGE_APP_SIZE, {w: width, h: height});
        },
